...
#
# my_email_address_split = my_email_address.split("@")  # xxx@xxx.xx
#
# # print(my_email_address_split)
# if len(my_email_address_split) != 2:
#     exit("Problème de @")
#
# # print(my_email_address_split[0])
# for caractere in my_email_address_split[0]:    # Vérifions la partie à gauche du @
#     if not caractere.isalnum() and caractere not in (".", "-"):
#         exit("La partie de gauche du @ contient des caractères interdits !")
#
# # Vérifions la partie de droite du @
# my_email_address_split_right = my_email_address_split[1].split(".")
# print(my_email_address_split_right)
#
# if len(my_email_address_split_right) != 2:
#     exit("Le nom de domaine est mauvais !")
#
# if my_email_address_split_right[0].isalpha() and my_email_address_split_right[1].isalpha():
#     print(f"L'adresse mail est correcte : {my_email_address}")
# else:
#     print("Le nom de domaine contient des caractères interdits !")
