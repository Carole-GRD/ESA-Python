...
def ajouter_cote(liste_etudiants, etudiant, calculer_moyenne):
    """
    ...
    :return: Rien.
    """
    cote_list = etudiant['cotes (sur 20)']
...
def modifier_cote(liste_etudiants, etudiant):
    """
...
def supprimer_cote(liste_etudiants, etudiant):
    """
...
def lire_une_cote(etudiant, cours):
    ...
    if not isinstance(etudiant.get('cotes (sur 20)'), dict):
        return None  # Aucun cours enregistré

    return etudiant['cotes (sur 20)'].get(cours, None)
